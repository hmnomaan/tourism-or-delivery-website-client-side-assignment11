                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col-12 p-3">
                        <div className="d-flex align-items-center">
                            ...
                            <h5 className="ms-2 mb-0 mt-1">TOURINCHINA</h5>
                        </div>
                        <p className="mission pe-lg-3 fs-6 pt-1">
                            We provide attractive packages to tour China. We have more than 10 destinations and local office for any support.
                    ...
                    <div className="col-md-4 col-12 ps-md-5 p-3">
                        <div className="important-links">
                            <p>Important Links</p>
                            <p className="mb-1"><a href="*">Privacy Policy</a></p>
                            <p className="mb-1"><a href="*">Terms of Service</a></p>
                            <p className="mb-1"><a href="*">Newsroom</a></p>
                            <p className="mb-1"><a href="*">Career</a></p>
                        </div>
                    </div>
